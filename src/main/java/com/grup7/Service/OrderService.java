/**
 * Sipariş yönetimi işlemlerini gerçekleştiren servis sınıfı.
 * Kullanıcıların seçtiği kategorileri içeren siparişlerin oluşturulması,
 * kaydedilmesi ve sorgulanması işlemlerini yönetir.
 * Sipariş verilerinin validasyonunu sağlar.
 */
